...
2.40 - September 2018 - Many small changes
2.41 - October 2018 - Avoid too small a time for next Layer 5 --> 4 event
*****************************************************************************/
...
void GenerateNextArrival()
{
    ...
    // With a slight change for Rev 2.41
    while ( x < ( 0.1 * AveTimeBetweenMsgs ) ) {
